...
# # # Hayward: 1898
city_rent = { 
  "Oakland" : 1573 , "San Jose" : 2103 , "Richmond" : 1436 , "Berkeley" : 1715 , "South San Francisco" : 1809 , "San Francisco" : 2352 , "Hayward" : 1898 
}
print(city_rent)
...
restaurant_visit = {
 "Amici Pizzeria": 4 , "Marica": 7 , "McD": 5
...
for x in restaurant_visit.keys():
  print(restaurant_visit.keys())
